...
html_temp6 = """
    ...
    <h3 style="color:#800080 ;text-align:left;">gallery image Control Using Hand Gestures </h3>
        <ul> Gestures and their Function
        <li>one: right  </li>
        <li>two : left </li>
        <li>three :zoom out</li>
...
#p="D:/photos/ptoto 1/images (2).jfif"
p="C:/project/Project/Project/src/images/test.png"
